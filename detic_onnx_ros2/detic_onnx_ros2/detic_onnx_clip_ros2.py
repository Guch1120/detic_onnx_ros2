...
class DeticNode(Node):
    ...
    def draw_predictions(
        ...
        for i in range(num_instances):
            ...
            clip_text = clip.tokenize([ "person", "duct tape","bottle of white"]).to(self.device)
            with torch.no_grad():
                # 推論
    ...
    def image_callback(self, msg):
        ...
        cv2.imshow("Image window", self.bridge.imgmsg_to_cv2(msg.rgb, "bgr8"))
        cv2.imshow("Result window", visualization)
        cv2.waitKey(1)
